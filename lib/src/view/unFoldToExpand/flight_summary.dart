...
class FlightSummary extends StatelessWidget {
  ...
  Color get mainTextColor => (theme == SummaryTheme.dark) ? Colors.white : const Color(0xFF083e64);
  Color get secondaryTextColor => (theme == SummaryTheme.dark) ? const Color(0xff61849c) : const Color(0xFF838383);
  Color get separatorColor => (theme == SummaryTheme.dark) ? const Color(0xffeaeaea) : const Color(0xff396583);

  TextStyle get bodyTextStyle => TextStyle(color: mainTextColor, fontSize: 13, fontFamily: 'Oswald', package: pkg);
  ...
  _getBackgroundDecoration() {
    return isLight
        ...
        : BoxDecoration(
            borderRadius: BorderRadius.circular(4.0),
            image: DecorationImage(image: AssetImage('images/bg_blue.png', package: pkg), fit: BoxFit.cover),
          );
  }
  ...
  _buildLogoHeader() {
    if (isLight) {
      return Row(
        ...
        children: <Widget>[
          Padding(
            ...
            child: Image.asset('images/flutter-logo.png', width: 8, package: pkg),
          ),
      ...
      return Padding(
        ...
        child: Image.asset('images/logo_white.png', height: 12, package: pkg),
      );
    }
  }
  ...
  Widget _buildTicketHeader(context) {
    var headerStyle = TextStyle(
        fontFamily: 'OpenSans', fontWeight: FontWeight.bold, fontSize: 11, color: const Color(0xFFe46565), package: pkg);
    return Row(
  ...
  Widget _buildTicketDuration() {
    ...
    final planeImage = Image.asset('images/airplane_$routeType.png', height: 20, fit: BoxFit.contain, package: pkg);
    return Column(
      ...
      children: <Widget>[
        SizedBox(
          ...
          child: Stack(
            ...
            children: <Widget>[
              Image.asset('images/planeroute_$routeType.png', fit: BoxFit.cover, package: pkg),
              isLight ? planeImage : _AnimatedSlideToRight(isOpen: isOpen, child: planeImage)
            ],
          ),
        ),
...
class _AnimatedSlideToRight extends StatefulWidget {
  ...
  const _AnimatedSlideToRight({super.key, required this.child, required this.isOpen});
