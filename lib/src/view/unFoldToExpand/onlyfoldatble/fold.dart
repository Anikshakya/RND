...
class FoldingCompartment extends StatefulWidget {
...
class _FoldingCompartmentState extends State<FoldingCompartment> with SingleTickerProviderStateMixin {
  ...
  double get openHeight => _entries.fold<double>(0.0, (val, o) => val + o.height) + FoldingCompartment.padding * 2;

  double get closedHeight => _entries[0].height + FoldingCompartment.padding * 2;
  ...
  @override
  void didUpdateWidget(FoldingCompartment oldWidget) {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(FoldingCompartment.padding),
